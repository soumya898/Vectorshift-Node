...
// from  here  react flow initialized  
...
export const PipelineUI = () => {
  ...
  className="w-full h-full relative bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] text-white"
>
        {/* <div ref={reactFlowWrapper} style={{width: '100wv', height: '100vh'}}> */}
            ...
            >
                <Background color="#aaaaaaff" gap={gridSize} />
                <Controls />
                <MiniMap />
            </ReactFlow>
        </div>
